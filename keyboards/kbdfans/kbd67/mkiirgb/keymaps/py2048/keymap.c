...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  */
	[_BASE] = LAYOUT_65_ansi_blocker(
		...
		KC_LSFT,          KC_Z,      KC_X,      KC_C,      KC_V,      KC_B,      KC_N,      KC_M,      KC_COMM,   KC_DOT,    KC_SLSH,        MT(MOD_RSFT, KC_END),KC_UP,     KC_DEL,
  ...
  */
	[_FN2] = LAYOUT_65_ansi_blocker(
		...
		_______,   _______,   KC_LALT,                         RGB_TOG,                                    _______,   MO(_FN3),             KC_HOME,   KC_VOLD,   KC_END
    ),
